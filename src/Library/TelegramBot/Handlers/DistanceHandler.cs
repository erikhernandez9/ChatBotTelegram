    ...
    public class DistanceHandler : BaseHandler
    {
        ...
        protected override void InternalHandle(Mensaje mensaje, out string response)
        {
            ...
            else if ((this.State == DistanceState.FromAddressPrompt) && (this.calculator != null))
            {
                ...
                this.Data.FromAddress = mensaje.Text;
            ...
            {
                this.Data.ToAddress = mensaje.Text;
            ...
            else if (((this.State == DistanceState.FromAddressPrompt) || (this.State == DistanceState.FromAddressPrompt))
